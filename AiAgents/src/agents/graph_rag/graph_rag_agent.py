...
class GraphRagAgent(BaseAgent):
    ...
    async def process(self, state: dict[str, Any]) -> dict[str, Any]:
        ...
        # If GenAISystem already generated a valid answer, use it!
        if backend_answer and backend_answer != "No relevant context found.":
            logger.info("GraphRagAgent: using answer generated by GenAISystem backend")
            answer = backend_answer

        else:
            logger.warning("GraphRagAgent: no backend answer found, synthesizing locally (fallback)")
            ...
            try:
                ...
                logger.error(f"GraphRagAgent fallback generation failed: {e}")
